...
class XboxBaseTeleop(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('max_linear_x', 0.544)
        self.declare_parameter('max_linear_y', 0.544)
        self.declare_parameter('max_angular_z', 1.866)
        self.declare_parameter('max_linear_speed', 0.370)
        self.declare_parameter('wheel_linear_speed_limit', 0.370)
        self.declare_parameter('kinematic_lever', 0.2225)
        self.declare_parameter('turbo_linear_x', 1.088)
        self.declare_parameter('turbo_linear_y', 1.088)
        self.declare_parameter('turbo_angular_z', 3.109)
