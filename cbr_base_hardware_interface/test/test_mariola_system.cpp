...
TEST_F(MariolaSystemTest, lifecycle_interfaces_and_stale_state)
{
  ...
  std::vector<cbr_interfaces::msg::WheelCommand> commands;
  auto command_subscription = test_node->create_subscription<cbr_interfaces::msg::WheelCommand>(
    "/test_mariola/command_velocities", rclcpp::QoS(1).reliable(),
    [&commands](const cbr_interfaces::msg::WheelCommand & message) {
