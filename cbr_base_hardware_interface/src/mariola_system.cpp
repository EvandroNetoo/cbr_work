#include "cbr_base_hardware_interface/mariola_system.hpp"
...
namespace cbr_base_hardware_interface
{
  ...
  const hardware_interface::HardwareComponentInterfaceParams & params)
{
  ...
  state_topic_ = parameter("state_topic", "/cbr_base_hardware/raw_joint_states");
  command_topic_ = parameter("command_topic", "/cbr_base_hardware/command_velocities");
  try {
...
hardware_interface::CallbackReturn MariolaSystem::on_activate(const rclcpp_lifecycle::State &)
{
  ...
  command_publisher_ = node_->create_publisher<cbr_interfaces::msg::WheelCommand>(command_topic_, qos);
...
hardware_interface::return_type MariolaSystem::write(const rclcpp::Time &, const rclcpp::Duration &)
{
  ...
  cbr_interfaces::msg::WheelCommand message;
