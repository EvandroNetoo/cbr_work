...
```bash
ros2 launch cbr_base_description display.launch.py
```

O launch carrega `rviz/cbr_base.rviz`, já configurado com frame fixo
...
```bash
ros2 launch cbr_base_description display.launch.py use_gui:=false
```
