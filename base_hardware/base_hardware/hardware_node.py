...
class BaseHardwareNode(Node):
    def __init__(self, backend=None):
        ...
        self.declare_parameter('hardware.max_wheel_velocity_rad_s', 11.0)
        ...
        self.declare_parameter('hardware.front_right.inverted', True)
        self.declare_parameter('hardware.rear_left.inverted', True)
        self.declare_parameter('hardware.rear_right.inverted', False)
        ...
        # controle enquanto o DDS aguarda ACK de um participante congestionado.
        qos = QoSProfile(
